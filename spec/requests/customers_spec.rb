...
#1.creates an entry (customer) with the factorybot
#2.specify a route to an existing entry (get new_customer_path)  
#and then you pass the id of the customer entry you create to the path
